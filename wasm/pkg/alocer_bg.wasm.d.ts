...
export function base58_encode(a: number, b: number, c: number): void;
export function base58_decode(a: number, b: number, c: number): void;
export function base64url_encode_padded(a: number, b: number, c: number): void;
export function base64url_decode_padded(a: number, b: number, c: number): void;
export function base64_encode_unpadded(a: number, b: number, c: number): void;
export function base64_decode_unpadded(a: number, b: number, c: number): void;
export function base64url_encode_unpadded(a: number, b: number, c: number): void;
export function base64url_decode_unpadded(a: number, b: number, c: number): void;
export function base64_encode_padded(a: number, b: number, c: number): void;
export function base64_decode_padded(a: number, b: number, c: number): void;
export function base16_encode_lower(a: number, b: number, c: number): void;
export function base16_encode_upper(a: number, b: number, c: number): void;
